...
function nameValidation() {
    ...
    if (name.length < 3) {
        nameError.innerHTML = '<i class="fa-solid fa-triangle-exclamation mx-1" style="color: #ff0000"></i> Please Enter a valid name';
        return false;
    } else {
...
function lnameValidation() {
    ...
    if (lname.length < 3) {
        ...
        lnameError.innerHTML = '<i class="fa-solid fa-circle-check px-2" style="color: #00ff00;"></i>'
        return true;
    }
...
function passwordValidation() {
    ...
    if (!password.match(/(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}/)) {
        ...
        passwordError.innerHTML = '<i class="fa-solid fa-circle-check px-2" style="color: #00ff00;"></i>'
        return true;
    }
}
...
function aadharValidation() {
    ...
    if (aadhar.length < 12) {
        aadharError.innerHTML = '<i class="fa-solid fa-triangle-exclamation mx-1" style="color: #ff0000;"></i> aadhar must be of 12 digits';
        return false;
    }
    if (!aadhar.match(/^\d{12}$/)) {
        aadharErrorError.innerHTML = '<i class="fa-solid fa-triangle-exclamation mx-1" style="color: #ff0000;"></i> Please enter valid aadhar no';
        return false;
    } else {
        aadharError.innerHTML = '<i class="fa-solid fa-circle-check px-2" style="color: #00ff00;"></i>'
        return true;
    }
}
...
function ageValidation() {
    ...
    if (age < 18) {
        ...
        ageError.innerHTML = '<i class="fa-solid fa-circle-check px-2" style="color: #00ff00;"></i>'
        return true;
    }
}
...
function addressValidation() {
    ...
    if (address.length < 15) {
        ...
        addressError.innerHTML = '<i class="fa-solid fa-circle-check px-2" style="color: #00ff00;"></i>'
        return true;
    }
}